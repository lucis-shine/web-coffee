...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/before/address/update.js"></script>
</head>
<body>
<div id="container">
             ...
             <div class="row">
                 <div class="col-md-12 column">
                     <div class="page-header" style="margin: 0px 0 20px;">
						<form id="update-form" role="form" class="form-horizontal" method="get">
						    <input type="hidden" id="addressid" name="addressid" value="${addressVO.id }">
							...
							<div class="form-group">
								<div class="col-md-offset-4 col-md-8">
									<button type="submit" class="btn btn-primary btn-sm" style="margin-left:80px;">修改</button>
